...
export const metadata: Metadata = {
  ...
  description:
    'Премиальный каталог промптов для маркетологов, SEO-специалистов, копирайтеров, блогеров и digital-команд. Готовые сценарии, коммерческие подборки и SEO-кластеры.',
  keywords: [
