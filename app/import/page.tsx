    ...
    <main className="mx-auto max-w-4xl px-4 py-10 sm:px-6 lg:px-8">
      <section className="rounded-[2rem] border border-white/10 bg-white/5 p-8 shadow-premium">
        ...
        <div className="mt-6 space-y-4 text-slate-300">
          ...
          <p>2. Для промптов подготовьте prompts-clean.json и проверьте категории / цены / file_url.</p>
          <p>3. Примените supabase-schema.sql в Supabase SQL Editor.</p>
          <p>4. Импортируйте данные в tools, prompts и clicks, затем включите RLS-политики.</p>
        </div>
